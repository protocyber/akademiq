...
Defines authentication and user management requirements for the iam-service (Identity & Access Management Service), including token-based authentication endpoints, Argon2id password hashing, RS256 JWT structure, secure internal user creation, user deletion compensating actions, and role seeding.
