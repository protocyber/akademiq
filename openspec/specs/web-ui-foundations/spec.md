# web-ui-foundations Specification

## Purpose
Specifies shared UI building blocks and layout conventions used across the web console (Tabs component, dialog scrolling, table screen layout).
## Requirements
