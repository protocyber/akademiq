# web-academic-scope Specification

## Purpose

Defines the global academic-scope context (academic year, curriculum version,
and academic term) shared across the web console header and all pages that
depend on the currently selected year/curriculum/term.
