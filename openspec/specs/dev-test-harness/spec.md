# dev-test-harness Specification

## Purpose

Defines testing and seeding requirements for local development and CI pipelines, including unit and integration tests for backend services, an end-to-end test suite, web application testing, idempotent demo data seeding, shared test builders in libs/common-testing, and CI validation.
