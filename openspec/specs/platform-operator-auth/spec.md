# platform-operator-auth Specification

## Purpose

Defines requirements for platform-operator accounts, platform-token issuance, and token-type isolation between the tenant plane and platform plane.
